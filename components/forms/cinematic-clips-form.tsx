...
import { Plus, X, Loader2, ChevronsUpDown, Film, Image as ImageIcon, CheckCircle, Check } from "lucide-react"
...
const mockArtifacts = [
  { id: "1", title: "Dramatic Scene", image: "/placeholder.jpg", description: "High-impact dramatic sequence" },
  { id: "2", title: "Action Sequence", image: "/placeholder.jpg", description: "Fast-paced action content" },
  { id: "3", title: "Emotional Moment", image: "/placeholder.jpg", description: "Touching emotional scene" },
  { id: "4", title: "Suspense Build", image: "/placeholder.jpg", description: "Tension-building sequence" },
  { id: "5", title: "Hero Shot", image: "/placeholder.jpg", description: "Powerful hero moment" },
  { id: "6", title: "Climax Scene", image: "/placeholder.jpg", description: "Peak dramatic moment" },
  { id: "7", title: "Reveal Moment", image: "/placeholder.jpg", description: "Surprising revelation scene" },
...
export function CinematicClipsForm({ onSave, onCancel, availableArtifacts }: CinematicClipsFormProps) {
  ...
  const handleSave = async () => {
    if (title.trim() && imagePreview && description.trim() && selectedArtifact) {
      ...
      toast({
        title: "Cinematic Clip created successfully",
      ...
      <div className="space-y-4">
        <div>
          ...
          <Input
            ...
            placeholder="Enter cinematic clip title"
          />
        </div>
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Describe your cinematic clip concept..."
            rows={3}
          />
        </div>
      </div>
